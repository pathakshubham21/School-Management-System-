...
<div style="position: absolute;left:950px;top:170px; height: 300px;width: 350px; border-radius: 10px; background-color: #2D4436" >
	...
	<h3 style="color: white;margin-left: 30px;">Total Time       :   10 min</h3>
		<h3 style="color: white;margin-left: 30px;">Total Marks      :   10 </h3>
			...
			<input type="button" value="Admin Home" onclick="window.location.href='admit data.php'"  style="border-radius: 5%;  background-color:white; color: black; height: 30px;width: 140px; border: solid 1px #c2c4c6; font-size:16px; padding-left:10px;position: absolute;left:1075px;top:430px;">
